...
import de.thws.Application.Exceptions.TaskNotFoundException;
...
public class NotificationUseCaseImpl implements NotificationUseCase {
    private static final Logger LOGGER = Logger.getLogger(NotificationUseCaseImpl.class.getName());
    ...
    @Inject
    public NotificationUseCaseImpl(TaskRepository taskRepository, NotificationRepository notificationRepository) {
